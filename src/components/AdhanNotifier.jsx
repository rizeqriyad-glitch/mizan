...
export default function AdhanNotifier() {
  const { prayerTimes, prayerNotifications } = useApp()
      ...
      {toast && (
        ...
        >
          <div style={{
            ...
            background: 'rgba(164, 169, 193,0.1)', border: '1px solid rgba(164, 169, 193,0.3)', // Mizan purple background/border
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '1.4rem', flexShrink: 0, color: 'var(--primary)',
          }}>{glyph('mosque')}</div>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {audioBlocked && (
              <button onClick={playAdhan} style={{
                ...
                borderRadius: '8px', border: '1px solid rgba(164, 169, 193,0.35)', // Mizan tokens
                background: 'rgba(164, 169, 193,0.1)', color: 'var(--mizan-purple)', // Mizan colors
