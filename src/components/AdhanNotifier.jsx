      ...
      {toast && (
        ...
        >
          <div style={{
            ...
            background: 'rgba(29, 127, 226,0.1)', border: '1px solid rgba(29, 127, 226,0.3)', // Mizan purple background/border
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            {audioBlocked && (
              <button onClick={playAdhan} style={{
                ...
                borderRadius: '8px', border: '1px solid rgba(29, 127, 226,0.35)', // Mizan tokens
                background: 'rgba(29, 127, 226,0.1)', color: 'var(--mizan-purple)', // Mizan colors
