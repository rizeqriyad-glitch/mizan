        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', flexWrap: 'wrap' }}>
          ...
          {expanded && surahsOnPage.slice(0, 2).map(name => (
            <span key={name} style={{
              ...
              background: 'var(--gold-dim)', border: '1px solid rgba(212,175,106,0.2)',
              ...
              {loading ? (
                ...
                <div style={{ padding: '2rem', textAlign: 'center' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'var(--gold-dim)', borderRadius: 'var(--radius-md)',
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: 'inset 0 0 60px rgba(212,175,106,0.05), 0 6px 24px rgba(0,0,0,0.15)',
                    minHeight: 300,
                  }}
                >
                  {/* Corner ornaments */}
                        ...
                        return (
                          <div key={`h-${i}`} style={{
                            ...
                            <div style={{
                              ...
                              <span style={{ color: 'rgba(212,175,106,0.6)', fontSize: '0.6rem' }}>◆</span>
                              <div>
                                <div style={{
                        ...
                        <span key={`a-${ayah.number}`} style={{ display: showTrans && trans ? 'block' : 'inline' }}>
                          ...
                          {showTrans && trans && (
                            <p style={{
                              ...
                              fontStyle: 'italic',
                              paddingLeft: '0.6rem',
                              borderLeft: '2px solid rgba(212,175,106,0.3)',
                            }}>
